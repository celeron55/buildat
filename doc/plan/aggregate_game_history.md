# aggregate: what was built

Moved out of `doc/plan/aggregate_game_plan.md`, which is frozen and now holds
only the model, the decisions on record, the risks and what it never spent.

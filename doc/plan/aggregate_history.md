# The engine under aggregate: what was built

Moved out of `doc/plan/aggregate_plan.md`, which now holds the scope, the
order and why it is that order, the risks and what it deliberately does not
do. Nothing here is a to-do.

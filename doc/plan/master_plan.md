...
1. **M3 -- it looks like the game.** The big one, and started: the game's
   ...
   `plantlike_rooted`, `firelike`, `torchlike`, `signlike`, `fencelike` and
   the liquids are built as shapes through buildat's
   own mesher (143 of 390, 83 of them liquids); `glasslike` and `allfaces`
